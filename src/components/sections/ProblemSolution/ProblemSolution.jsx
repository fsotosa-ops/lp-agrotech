// fsotosa-ops/lp-agrotech/lp-agrotech-e9c68edcb52ef6e076d84636da269a24fe8f5ec7/src/components/sections/ProblemSolution/ProblemSolution.jsx

import styles from './ProblemSolution.module.css';

// === INICIO DE CAMBIOS ===

// --- ÍCONOS DE TU SITIO PRINCIPAL ---

// 1. Icono para "Anticipación" (Reloj) - ¡NUEVO!
...
// 2. Icono para "Análisis de Datos" (Gráfica de barras)
const IconAnalysis = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
// 3. Icono para "Automatización" (Rayo)
...
// 4. Icono para "Crecimiento" (Gráfico de torta)
const IconGrowth = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
// --- DATOS: Mapeamos los nuevos íconos a los hitos ---
const roadmapData = [
  {
    solution: 'Anticipación de Riesgos',
    problem: 'Riesgos Operativos Tardíos',
    icon: <IconAnticipation /> // ¡CAMBIADO!
  },
  {
  ...
  return (
    <section className={`${styles.section} section-container`}>
      ...
      <h3 className={styles.subtitle}>
        Resultados y mejoras clave que logras con SumaDots.
      </h3>
